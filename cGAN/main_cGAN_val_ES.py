...
# Summary of the generator, adapt the size of the input image
summary(UNet().cuda(), (1, 192, 192))


#####################################################################################################################discriminator
from discriminator import Discriminator
# Summary of the dicriminator, adapt the size of the input image
summary(Discriminator().cuda(), [(1, 192, 192), (1, 192, 192)])



#######################################################################################################################load training
from train_cGAN_val_ES import train_net

generator_cgan = train_net(train_loader, train_ds, val_loader, outdir, patience=patience, num_epoch=num_epoch, lr=lr)
