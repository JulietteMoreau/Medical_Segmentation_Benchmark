...
train_images = sorted(glob.glob(train_dir + "*.nii.gz"))
train_labels = sorted(glob.glob(train_dir_label + "*.nii.gz"))

val_images = sorted(glob.glob(val_dir + "*.nii.gz"))
val_labels = sorted(glob.glob(val_dir_label + "*.nii.gz"))

test_images = sorted(glob.glob(test_dir + "*.nii.gz"))
test_labels = sorted(glob.glob(test_dir_label + "*.nii.gz"))
...
bs = 2 #batch size, can be modified
...
# Summary of the architecture, adapt the size of the input image
