...
summary(UNETR().cuda(), (1, 192, 192))


#######################################################################################################################load training
from train_UNETR_val_ES import train_net

model = train_net(train_loader, train_ds, val_loader, val_ds, outdir, patience=patience, num_epoch=num_epoch, lr=lr)
